...
class DriftForager(object):
    ...
    def handlingStats(self, preyType, preyVelocity):
        ...
        turnCostFactor = 0.9601 * np.exp(0.02665 * preyVelocity) # factor in the additional cost of turning beyond that of unsteady swimming, Hayes et al 2016 eqn 9, with cm-to-m conversion 0.01 EDITED FOR TRANSLATION ERROR from JH
