...
class PreyType(object):
    ...
    def __init__(self, label, minLength, maxLength, driftDensity, energyDensityCalories, a=None, b=None, dryMass=None):
        self.label = label
        ...
        self.dryMass = dryMass if dryMass is not None else self.a * ((self.minLength + self.maxLength) / 2) ** self.b
